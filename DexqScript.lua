...
local RaritiesList = {
    ...
    "Eternity", "Academy", "Dynasty", "Grail", "Mystery", "VIP", "Event", "Limited", "Raven", "Arcane", "Nightfall", "Evolution","Smash", "Emblem", "Chrono","Dunk", "Blossom", "Zenith", "Assassin", "Power", "Rebellion", "Azure", "Psychic", "Cosmos", "Requiem", "Crimson", "Valkyrie"
}
